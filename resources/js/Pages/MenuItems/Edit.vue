...
const form = useForm({
    menu_id: props.menuItem.menu_id,
...
const updateMenuItem = async () => {
    await form.post(route('menu_items.update', props.menuItem), {
        preserveScroll: true,
        preserveState: true,
        replace: true,
        onSuccess: () => {
            toast('Successfully updated menu items!', {
                autoClose: 1000,
            })
        }
    });
    ...
    <div class="mt-5">
      <form @submit.prevent="updateMenuItem">
        <div class="my-4">
            ...
            <select v-model="form.menu_id" name="menu_id" id="menu_id" class="w-full rounded py-2">
